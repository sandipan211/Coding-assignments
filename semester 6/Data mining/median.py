# -*- coding: utf-8 -*-
"""
Created on Fri Jan 19 10:59:08 2018
...
for i in range(0,150):
    ...
    d_row_avgs[i] = statistics.median(dice[i])
    j_row_avgs[i] = statistics.median(jaccard[i])
    c_row_avgs[i] = statistics.median(cosine[i])
    o_row_avgs[i] = statistics.median(overlap[i])
